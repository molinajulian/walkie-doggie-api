...
exports.coverLetter = `${stringMessage('cover_letter')} ${containedMessage('body')}`;
...
exports.dayOfWeek = `${oneOfMessage('day_of_week', Object.values(DAYS_OF_WEEK))} ${containedMessage('ranges.*')}`;
exports.startAt = `${hourMessage('start_at')} ${containedMessage('ranges.*')}`;
exports.endAt = `${hourMessage('end_at')} ${containedMessage('ranges.*')}`;
